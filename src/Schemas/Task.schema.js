...
export const TaskSchema = z.object({
    ...
    weatherConditions: z.string().min(1, { message: "Las condiciones meteorológicas son obligatorias" }),
    habitatDescription: z.string().min(1, { message: "La descripción del hábitat es obligatoria" }),
    samplingPhotos: z.array(z.string()).min(1, { message: "Se requiere al menos una foto de muestreo" }),
